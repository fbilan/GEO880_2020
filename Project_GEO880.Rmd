...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = TRUE, fig.cap="Figure 9: The average number of trips per day type (weekday-day vs. weekend-day)."}
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = TRUE, fig.cap="Figure 10: The average number of trips on each day of the week."}
...
## Trip Pattern Analysis  
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = TRUE, fig.cap="Figure 11: An analysis of electric and standard bikes in terms of different movement parameters."}
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = TRUE, fig.cap="Figure 12: The average number of trips by commuters and tourists over the course of a day."}
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = TRUE, fig.cap="Figure 13: The average number of trips over the course of a day, comparing commuters and tourists."}
par(mfrow=c(1,2))
...
```{r message=FALSE, warning=FALSE, eval = TRUE, echo = TRUE, fig.cap="Figure 14: The average number of trips per day of the week the course of a day, comparing commuters and tourists."}
par(mfrow=c(1,2))
